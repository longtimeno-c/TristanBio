        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          {currentWorkItems.length > 0 && (
            <section className="w-full max-w-6xl mx-auto">
              <div className="py-6 border-t border-gray-200 dark:border-gray-700 mb-8"></div>
              
              <h2 className="text-4xl font-bold mb-12 text-center bg-gradient-to-r from-indigo-400 via-purple-500 to-pink-500 bg-clip-text text-transparent">
