      ...
      <main className="min-h-screen relative">
        ...
        <div className="fixed inset-0 z-0">
          ...
          <div className="relative h-full w-full">
            ...
            {/* Will add the background image once available */}
          </div>
        </div>
        ...
        <div className="relative z-10 px-4 pt-32 pb-16 max-w-7xl mx-auto">
          ...
          <section className="mb-20 text-center">
            <div className="flex justify-center mb-8">
              {/* Will replace with actual icon when available */}
              <div className="rounded-full bg-gray-800 p-6 border-2 border-amber-600 shadow-lg shadow-amber-600/20">
                <svg className="w-16 h-16 text-amber-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
