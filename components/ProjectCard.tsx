type ProjectProps = {
  ...
  export default function ProjectCard({ title, description, link, tech }: ProjectProps) {
    return (
      <a href={link} target="_blank" rel="noopener noreferrer" className="block bg-white dark:bg-gray-800 rounded-lg shadow hover:shadow-lg transition duration-300 p-6">
